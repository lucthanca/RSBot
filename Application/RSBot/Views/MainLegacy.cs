...
namespace RSBot.Views
{
    public partial class MainLegacy : Form
    {
        ...
        public MainLegacy()
        {
            ...
            DoubleBuffer.Set(panel1);
            DoubleBuffer.Set(tabMain);
            DoubleBuffer.Set(bottomPanel);
            DoubleBuffer.Set(pSidebar);
            RegisterEvents();
        }
        ...
        private void LoadExtensions()
        {
            ...
            foreach (var extension in extensions.Where(extension => extension.Value.DisplayAsTab))
            {
                ...
                ite.Text = LanguageManager.GetLangBySpecificKey(extension.Value.InternalName, "DisplayName", extension.Value.DisplayName);
                ite.Tag = control;
                tabList.Items.Add(ite);
            ...
            tabList.Items[0].Selected = true;
            panel1.Controls.Add((Control)tabList.Items[0].Tag);
        ...
        {
            if (tabList.SelectedItems.Count > 0)
            {
                ListViewItem selectedListViewItem = tabList.SelectedItems[0];
                panel1.Controls.Clear();
                panel1.Controls.Add((Control)selectedListViewItem.Tag);
            }
        }
    }
}